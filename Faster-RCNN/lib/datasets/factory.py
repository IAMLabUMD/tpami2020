...
# Set up TOR feedback
for split in ["train", "val", "test", "train-wholeBB", "val-wholeBB", "test-wholeBB",\
              "train-hand", "val-hand", "test-hand",\
              "train-hand-wholeBB", "val-hand-wholeBB", "test-hand-wholeBB",\
              "train-noshuffle", "val-noshuffle", "test-noshuffle",\
              "train-noshuffle-wholeBB", "val-noshuffle-wholeBB", "test-noshuffle-wholeBB",\
              "train-hand-noshuffle", "val-hand-noshuffle", "test-hand-noshuffle",\
              "train-hand-noshuffle-wholeBB", "val-hand-noshuffle-wholeBB", "test-hand-noshuffle-wholeBB"]:
