...
class FCN8VGG:
    ...
    def build(self, rgb, train=False, num_classes=20, random_init_fc8=False,
              num_obj_classes=20, use_dilated=False, is_recognition=False,
              is_shallow=False, debug=False):
        """
        ...
        # self.pred = self._fc_layer(self.fc7, "fc8",
