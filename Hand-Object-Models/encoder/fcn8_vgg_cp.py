...
def inference(hypes, images, train=True):
    ...
    vgg_fcn = fcn8_vgg_cp.FCN8VGG(vgg16_npy_path=vgg16_npy_path)
    ...
    logits['fcn_logits'] = vgg_fcn.upscore32_1 # localization output
    logits['fcn_logits2'] = vgg_fcn.upscore32 # hand output
    ...
    vars_to_save = (vgg_fcn.conv1_1, vgg_fcn.conv1_2,
                    ...
                    vgg_fcn.fc6, vgg_fcn.fc7, vgg_fcn.score_fr,
                    vgg_fcn.upscore2, vgg_fcn.upscore4, vgg_fcn.upscore32)
    # list of variables for training
    vars_to_train = (vgg_fcn.conv5_1_1, vgg_fcn.conv5_1_2, vgg_fcn.conv5_1_3,
                     vgg_fcn.fc6_1, vgg_fcn.fc7_1, vgg_fcn.score_fr_1,
                     vgg_fcn.upscore2_1, vgg_fcn.upscore4_1, vgg_fcn.upscore32_1)

    logits['saving_vars'] = vars_to_save
    logits['training_vars'] = vars_to_train
