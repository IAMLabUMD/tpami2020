"""
test an object localization model
"""
...
def main(args):
  ...
  with open(test_file, 'r') as f:
    for line in f:
      ...
      # estimate
      est_local = estimate(model, image, model_type, threshold)
...
if __name__ == '__main__':
  ...
  parser.add_argument("--input_file", help="file containing a list of image paths")
